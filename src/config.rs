...
fn parse_key_event(raw: &str) -> Result<KeyEvent, String> {
    let raw_lowercase = raw.to_ascii_lowercase();
    let (remaining, modifiers) = extract_modifiers(&raw_lowercase);
